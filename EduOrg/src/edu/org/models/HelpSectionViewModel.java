...
public class HelpSectionViewModel implements Serializable {
    ...
    public HelpSectionViewModel() {
        ...
        TreeNode first_0 = new DefaultTreeNode(new SimpleStringValueLineItem("Измененная структура", "help/1-5.xhtml"), root);
        ...
        TreeNode first_7 = new DefaultTreeNode(new SimpleStringValueLineItem("- Работа с некоректными данными", "help/1-7.xhtml"), firstChild);
